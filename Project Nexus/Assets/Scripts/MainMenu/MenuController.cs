...
public class MenuController : MonoBehaviour
{
    ...
    {
        mainContollerSen = Mathf.RoundToInt(sensitivity);
    ...
    public void GameplayApply()
    {
        ...
        PlayerPrefs.SetFloat("masterSen", mainContollerSen);
        StartCoroutine(ConfirmationBox());
    }
    ...
    public void GraphicsApply()
    {
        ...
        //change your brightness with yuor post processing or whatever it is
